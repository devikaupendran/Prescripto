...
const DoctorProfile = () => {
    ...
    //function to handle the edit profile
    ...
    //if there is profile data then only show this ui
    return profileData && (
        <div>
            <div className='flex flex-col gap-4 m-5'>
                <div>
                    <img src={profileData.image} className='bg-blue-500/80 w-full sm:max-w-64 rounded-lg' alt="doctor image" />
                </div>

                <div className='flex-1 border border-stone-100 rounded-lg bg-white p-8 y-7 shadow-lg'>
                    ...
                    <p className='text-gray-600 mt-4 font-medium'>Appointment fee:
...

                    {
                        isEdit ?
                            <button onClick={updateProfile}
                                className='px-4 py-1 border border-blue-400 text-sm rounded-full mt-5 cursor-pointer hover:bg-blue-400 hover:text-white transition-all'>
                                Save</button>
                            :
